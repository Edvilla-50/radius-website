...
$ch = curl\_init("$backend/user/$userId/profile-html");
...
(function () {
    ...
    async function checkExistingConnection() {
        ...
        try {
            ...
            const res = await fetch(\`${BACKEND}/api/music/${USER\_ID}\`);
    ...
    musicConnectBtn.addEventListener("click", async () => {
        ...
        try {
            ...
            const res = await fetch(\`${BACKEND}/api/music/connect/${USER\_ID}\`, {
    ...
    musicDisconnectBtn.addEventListener("click", async () => {
        ...
        try {
            ...
            const res = await fetch(\`${BACKEND}/api/music/disconnect/${USER\_ID}\`, {
